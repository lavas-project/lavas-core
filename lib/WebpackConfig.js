    ...
    (0, _createClass3.default)(WebpackConfig, [{
        ...
        value: function base(config) {
            var globals = config.globals,
                ...
                babel = config.babel;
            var base = webpack.base,
                shortcuts = webpack.shortcuts,
                _webpack$mergeStrateg = webpack.mergeStrategy,
                mergeStrategy = _webpack$mergeStrateg === undefined ? {} : _webpack$mergeStrateg,
                build = webpack.build;
            ...
            var clientConfig = _webpackMerge2.default.strategy(mergeStrategy)(baseConfig, {
                ...
                plugins: [new _webpack2.default.DefinePlugin({
                    ...
                    minChunks: function minChunks(module, count) {
                        return module.resource && /\.js$/.test(module.resource) && module.resource.indexOf((0, _path.join)(globals.rootDir, 'node_modules')) === 0;
                    }
                }), new _webpack2.default.optimize.CommonsChunkPlugin({
                    name: 'vue',
                    minChunks: function minChunks(module, count) {
