...
var RouteManager = function () {
    function RouteManager(core) {
        ...
        (0, _assign2.default)(this, {
            targetDir: (0, _path.join)(core.config.globals.rootDir, './.lavas'),
    ...
    (0, _createClass3.default)(RouteManager, [{
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                _context2.next = 3;
                                return (0, _fsExtra.emptyDirSync)(skeletonsDir);
        ...
        value: function () {
            var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4() {
                ...
                var mpaConfig, skeletonEntries, skeletonConfig;
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                mpaConfig = (0, _webpackMerge2.default)(this.core.webpackConfig.client(this.core.config));
                                skeletonEntries = {};
                            ...
                            case 7:
                                ...
                                if ((0, _keys2.default)(skeletonEntries).length) {
                                    skeletonConfig = (0, _webpackMerge2.default)(his.core.webpackConfig.server(this.core.config));
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _context5.next = 4;
                                return (0, _router.generateRoutes)(path.resolve(__dirname, '../pages'));
                            ...
                            case 4:
                                ...
                                _context5.next = 9;
                                return (0, _fsExtra.ensureFileSync)(routesFilePath);
